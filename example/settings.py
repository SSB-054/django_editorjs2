...
SECRET_KEY = "django-insecure-q%icqnzoakr_xtw60xmvhfw9wy7r)u&22jz%q#%!^!=(tc!3f*"
...
DJANGO_EDITORJS2_CONFIG = {
    # preprocessors during the preview generation from blockeditor json
